...
class PatchServiceBrokerRequestExtended(BaseModel):
    """
    ...
    authentication_current: Optional[Authentication] = None
    __properties: ClassVar[List[str]] = ["name", "url", "authentication", "metadata", "authentication_current"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of authentication_current
        if self.authentication_current:
            _dict['authentication_current'] = self.authentication_current.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "authentication_current": Authentication.from_dict(obj["authentication_current"]) if obj.get("authentication_current") is not None else None
        })
        return _obj
