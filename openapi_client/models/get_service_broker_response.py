...
class GetServiceBrokerResponse(BaseModel):
    """
    ...
    name: StrictStr
    url: StrictStr
    relationships: Optional[Dict[str, ToOneRelationship]] = None
    metadata: Optional[Metadata] = None
    links: Optional[Dict[str, Link]] = None
    __properties: ClassVar[List[str]] = ["guid", "created_at", "updated_at", "name", "url", "relationships", "metadata", "links"]
